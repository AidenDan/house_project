    ...
    $(function(){
        ...
        $('#dg').datagrid({
            ...
            columns: [[
                ...
                { field: 'districtId', title: '城市编号', width: 50, align: "center"},
                { field: 'opt', title: '操作', width: 50, align: "center",
                    formatter: function(value,row,index){
                        //同步跳转 "<a href='delStreet?id="+row.id+"'>删除</a>  value 表示当前字段的值， row当前行的值 index表示索引"
