	 ...
	 var _menus = {"menus":[
						{"menuid":"1","icon":"icon-sys","menuname":"常规设置",
							"menus":[
									...
									{"menuid":"13","menuname":"城区管理","icon":"icon-users","url":"admin/district.jsp"},
									{"menuid":"14","menuname":"街道管理","icon":"icon-role","url":"admin/street.jsp"},
									{"menuid":"15","menuname":"类型设置","icon":"icon-set","url":"admin/type.jsp"}
								]
						},{"menuid":"8","icon":"icon-sys","menuname":"房屋管理",
							"menus":[{"menuid":"21","menuname":"房屋审核","icon":"icon-nav","url":"admin/verify.jsp"},
									{"menuid":"22","menuname":"已审核","icon":"icon-nav","url":"admin/verified.jsp"},
                                    {"menuid":"23","menuname":"未审核","icon":"icon-nav","url":"admin/unverified.jsp"}
								]
						},{"menuid":"56","icon":"icon-sys","menuname":"用户管理",
							"menus":[{"menuid":"31","menuname":"搜索用户","icon":"icon-nav","url":"admin/user.jsp"},
...
<div style=" position:absolute; z-index:100000; height:2046px;top:0px;left:0px; width:100%; background:white; text-align:center;">
    ...
    <div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
        <div class="footer">汉房后台管理系统  版权归汉房所有  联系方式:13260601227</div>
    </div>
