...
<div id="ToolBar">
    <div style="height: 40px;">
       ...
       <%-- 用户名:<input type="text" id="inputName" name="cname">电话:<input id="inputTel" type="text" name="ctelephone">--%>
            ...
            <a
                    href="javascript:goVerifyByBatch()" class="easyui-linkbutton"
...
<script>
    ...
    $(function () {
        ...
        /*区域与街道的级联操作，区域下拉框一改变那么就异步请求查询对应的街道*/
...
<script>
    ...
    function goVerifyByBatch() {
       ...
       if(selObjs.length>0){
            /*前台不能直接传一个数组或集和到后台*/
            $.messager.confirm("友情提示", "确认审核通过吗", function (r) {
               if (r){
                    //r=true表示点击ok 否则点击取消
                    //发送异步请求调用接口实现批量删除   ids=1,2,3,4
                    //获取选中项的值id,拼接成:  值1,值2,值3
