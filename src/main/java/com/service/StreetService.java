...
public interface StreetService {
     ...
     *
     */
    PageInfo<Street> findAllStreet(PageUtils pageUtils);

    /**
     *
     *
     * @description:
     * @param Street //封装区域的名字
     * @return: 添加成功就返回1
     * @author: Aiden
     * @time: 2019-12-22 19:01:24
     */
    Integer addStreetService(Street Street);
     ...
     * @param Street，封装了序列化的数据
     * @return:
     * @author: Aiden
     * @time: 2019-12-23 10:08:56
     */
    Integer upStreet(Street Street);
     ...
     */
     Integer removeStreetById(Integer id);
      ...
      */
     Integer removeStreetByBatch(Integer[] ids);
